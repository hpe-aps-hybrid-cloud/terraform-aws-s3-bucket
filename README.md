# AWS S3 bucket Terraform module for HPE Self-Paced Hybrid-cloud Terraform Lab
...
## License
Module copied from https://github.com/terraform-aws-modules/terraform-aws-s3-bucket
